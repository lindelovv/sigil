...
namespace sigil::renderer {
    ...
    PipelineBuilder& PipelineBuilder::set_shaders(vk::ShaderModule vertex, vk::ShaderModule fragment) {
        shader_stages.clear();
        shader_stages = {
    ...
    PipelineBuilder& PipelineBuilder::set_input_topology(vk::PrimitiveTopology topoloty) {
    ...
    PipelineBuilder& PipelineBuilder::set_cull_mode(vk::CullModeFlagBits cull_mode, vk::FrontFace front_face) {
    ...
    PipelineBuilder& PipelineBuilder::enable_blending_addative() {
        color_blend_attachment.colorWriteMask      = vk::ColorComponentFlagBits::eR | vk::ColorComponentFlagBits::eG
                                                   | vk::ColorComponentFlagBits::eB | vk::ColorComponentFlagBits::eA;
    ...
    PipelineBuilder& PipelineBuilder::set_color_attachment_format(vk::Format format) {
    ...
    PipelineBuilder& PipelineBuilder::enable_depthtest(bool write_enable, vk::CompareOp op) {
    ...
    PipelineBuilder& PipelineBuilder::set_layout(vk::PipelineLayout in_layout) {
        layout = in_layout;
        return *this;
    }
